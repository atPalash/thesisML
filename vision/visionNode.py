...
def detect_object_and_gripping_point(data):
    ...
    for img in images:
        ...
        if object_identifier.predict(image_rgb) is data:
...
if __name__ == "__main__":
    ...
    ready_for_snap_sub = rospy.Subscriber('find_gripping_point', String, detect_object_and_gripping_point, object_name)
    snap_taken_pub = rospy.Publisher('reply_gripping_point', String, queue_size=1)
